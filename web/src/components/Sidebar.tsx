...
import { LogOut, LayoutDashboard, BarChart3, TrendingUp, FileText, Settings, Calculator, Calendar, Sparkles, Newspaper, X, Landmark, Activity, Image as ImageIcon } from 'lucide-react'
...
export default function Sidebar({ mobileOpen = false, onClose }: SidebarProps) {
    ...
    const navItems = [
        ...
        { to: '/stock-screener', label: 'Stock Screener', icon: Activity },
